...
import com.soufun.widget.wheel.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private static final int[] SHADOWS_COLORS = new int[] { 0xFFCCCCCC,
	...
	public void setCurrentItem(int index, boolean animated) {
		...
		if (index != currentItem) {
			if (animated) {
				...
				int old = currentItem;
				currentItem = index;
				if (viewAdapter.layoutIsNull()) {
					viewAdapter.setItemsLayout(itemsLayout);
				}
