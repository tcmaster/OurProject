 ...
 */
package com.soufun.widget.wheel.adapter;
...
public abstract class AbstractWheelTextAdapter extends AbstractWheelAdapter {
	...
	private Map<Integer, TextView> maps;
	...
	protected AbstractWheelTextAdapter(Context context, int itemResource,
		...
		maps = new HashMap<Integer, TextView>();
	 ...
	 */
	@Override
	public void setCurrentItem(int currentItem, String[] array) {
		this.currentItem = currentItem;
		if (itemLayout != null) {
			int finalCurrentItem = currentItem;
			TextView tv = (TextView) itemLayout.getChildAt(0);
			if (tv != null) {
				String keyStr = tv.getText().toString();
				for (int i = 0; i < array.length; i++) {
					if (keyStr.equals(array[i]))
						break;
					finalCurrentItem--;
				}
			}
			...
			for (int i = 0; i < itemLayout.getChildCount(); i++) {
				TextView tView = (TextView) itemLayout.getChildAt(i);
				if (tView != null)
					if (i == finalCurrentItem)
						tView.setTextColor(Color.BLACK);
					else
						tView.setTextColor(DEFAULT_TEXT_COLOR);
			}
		}
	};
	...
	public boolean layoutIsNull() {
		return itemLayout == null ? true : false;

	};

	@Override
	public void setItemsLayout(LinearLayout layout) {
