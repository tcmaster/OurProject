...
public class Dlg_City_Adapter extends BaseAdapter {
	...
	public Dlg_City_Adapter(Context context) {
		infos = new ArrayList<CityInfo>();
	...
	public void bindData(List<CityInfo> infos) {
		this.infos = infos;
