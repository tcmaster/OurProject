...
public class SystemMessageAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		LogUtils.v("到了这里，说明有数据输入" + msg.toString());
		convertView = null;
			...
			if (msg.getCallUrl().equals("ok")) {
				...
				msgAgree.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						// 这里用了专门的直接post的方法
						final HttpPostInterface interface1 = new HttpPostInterface();
						new Thread(new Runnable() {

							@Override
							public void run() {
								interface1.postDirect(msg.getCallUrl(), new HttpPostCallBack() {
	...
	public void bindData(List<AdminMessage> dataSource) {
		LogUtils.v("应该会插入数据了");
