	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (convertView == null) {
			...
			holder.img = (NetworkImageView) convertView
					.findViewById(R.id.nearbyper__img);
			holder.age = (TextView) convertView
					.findViewById(R.id.nearbyper__age);
			holder.astro = (TextView) convertView
					.findViewById(R.id.nearbyper__astro);
			holder.distance = (TextView) convertView
					.findViewById(R.id.nearbyper_distance);
			holder.name = (TextView) convertView
					.findViewById(R.id.nearbyper_name);
			holder.sexImg = (ImageView) convertView
					.findViewById(R.id.nearbyper__seximg);
			holder.signature = (TextView) convertView
					.findViewById(R.id.nearbyper__signature);
			holder.time = (TextView) convertView
					.findViewById(R.id.nearbyper_time);
